...
namespace Quanlythuvien.Migrations
{
    public partial class v1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "PhieuMuons",
                columns: new[] { "MaPhieuMuon", "MaDocGia", "NgayMuon", "NgayPhaiTra" },
                values: new object[] { "PM1", "DG001", new DateTime(2025, 6, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null });

            migrationBuilder.InsertData(
                table: "PhieuMuons",
                columns: new[] { "MaPhieuMuon", "MaDocGia", "NgayMuon", "NgayPhaiTra" },
                values: new object[] { "PM2", "DG001", new DateTime(2025, 6, 3, 0, 0, 0, 0, DateTimeKind.Unspecified), null });
